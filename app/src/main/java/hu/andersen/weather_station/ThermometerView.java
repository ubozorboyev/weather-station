...
public class ThermometerView extends View {
    ...
    private RectF rectBg = new  RectF(0f, 0f, 0f, 0f);
    ...
    private void init(AttributeSet attrs) {
        ...
        unitTextSize = typedArray.getDimension(R.styleable.ThermometerView_unitTextSize, 40f);
        unitTextColor = typedArray.getColor(R.styleable.ThermometerView_unitTextColor, Color.parseColor("#FFFFFF"));
        scaleTextSize = typedArray.getDimension(R.styleable.ThermometerView_scaleTextSize, 24f);
        scaleTextColor = typedArray.getColor(R.styleable.ThermometerView_scaleTextColor, Color.parseColor("#FFFFFF"));
        ...
        maxLineWidth = typedArray.getFloat(R.styleable.ThermometerView_maxLineWidth, 50f);
        midLineWidth = typedArray.getFloat(R.styleable.ThermometerView_midLineWidth, 30f);
        minLineWidth = typedArray.getFloat(R.styleable.ThermometerView_minLineWidth, 15f);
        spaceScaleWidth = typedArray.getFloat(R.styleable.ThermometerView_spaceScaleWidth, 20f);
        thermometerBg = typedArray.getColor(R.styleable.ThermometerView_thermometerBg, Color.LTGRAY);
        thermometerShadowBg = typedArray.getColor(R.styleable.ThermometerView_thermometerShadowBg, Color.parseColor("#F0F0F0"));
        maxThermometerRadius = typedArray.getFloat(R.styleable.ThermometerView_maxThermometerRadius, 70f);
        minThermometerRadius = typedArray.getFloat(R.styleable.ThermometerView_minThermometerRadius, 30f);
        ...
        minScaleValue = typedArray.getFloat(R.styleable.ThermometerView_minScaleValue, 0f);
    ...
    protected void onDraw(Canvas canvas) {
       ...
       initConfig();
        ...
        canvas.drawRoundRect(rectBg, roundCorner, roundCorner, paint);
...
//        shapePaint.setColor(rightMercuryColor);
    ...
    static String getFahrenheitValues(float curValue){

        return  new DecimalFormat("#.#").format((curValue) * 1.8f + 32f)  + "℉" ;
    ...
    public static class ThermometerBuilder {
        ...
        private float minScaleValue = 10f; // 温度计最小值
